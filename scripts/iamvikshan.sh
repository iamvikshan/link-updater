...
#
# Options:
#   --repo <url>       Override the target repository URL (default: https://github.com/iamvikshan/link-updater.git)
...
DEFAULT_TARGET_REPO="https://github.com/iamvikshan/link-updater.git"
...
HTTP_STATUS=$(echo "$SCOPE_CHECK_OUTPUT" | head -1 | grep -oE '[0-9]{3}' | head -1 || echo "")
